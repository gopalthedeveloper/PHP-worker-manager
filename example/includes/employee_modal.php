...
<div class="modal fade" id="upload_excel">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
              <form class="form-horizontal" method="POST" action="employee_upload_excel.php" enctype="multipart/form-data">
                <div class="form-group">
                ...
                <a href="<?=$_SERVER['HTTP_HOST']?>/dist/attachments/sampleEmployeeImport.csv">
				  	Sample Csv file
                </a>
            </div>
            <div class="modal-footer">
